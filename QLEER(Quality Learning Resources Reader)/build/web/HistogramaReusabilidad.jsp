<%-- 
    Document   : HistogramaReusabilidad.jsp
    Created on : 20-may-2023, 2:53:39
    Author     : efcas
--%>
...
<html>
    ...
    <body>
        ...
        <center><h2>Distribución de los datos con respecto a Reusabilidad</h2></center>
              <%

           obtenerReusabilidad oL = new obtenerReusabilidad();

            ArrayList<Double> listaValores = oL.ObtenerDatosReusabilidad2();
