 ...
 * @author efcas
 */
public class serviciosEstadisticosClienteCorrectitud {
    
    
     public double ObtenerMediaCorrectitud(ArrayList <Double> list){
       Media_Service  service  =  new servicios_estadisticos.Media_Service();
       Media port = service.getMediaPort();
       return port.media(list);
    }
    
    public double ObtenerMedianaCorrectitud(ArrayList <Double> list){
    ...
    public double ObtenerModaCorrectitud(ArrayList <Double> list){
       Moda_Service  service  =  new servicios_estadisticos.Moda_Service();
       Moda port = service.getModaPort();
       return port.moda(list);
    }
    
    public double ObtenerVarianzaCorrectitud(ArrayList <Double> list){
    ...
    public double ObtenerRangoCorrectitud(ArrayList <Double> list){
    ...
    public double ObtenerDesviacionEstandarCorrectitud(ArrayList <Double> list){
    ...
    public double ObtenerCurtosisCorrectitud(ArrayList <Double> list){
